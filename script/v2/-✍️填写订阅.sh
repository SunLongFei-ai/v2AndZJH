...
#在下面url的双引号里面填入订阅链接
url="https://ghelper.me/rss/df46e0db6e7896484e7ac84c7dd2a8cc"
...
host=\"$host\"
DNS=\"119.29.29.29\"
" >  $curPath/config/$name.$remark.ini
echo -e '/system/bin/sh /data/v2//执行订阅节点/*/ZJL -c
cd /data/v2/
project_name="${0##*/}"
